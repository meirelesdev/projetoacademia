            ...
            <div className={styles["fundogray"]}>
                ...
                <div className={styles["ulbuttonsocial"]} >
                    ...
                    <ul className={styles["listasociais"]}>
                        <li><Link href="#" ><a class={styles["botaosocial"]}><img src="assets/Icon/face.svg" id={styles["icon"]} /></a></Link></li>
                        <li><Link href="#" ><a class={styles["botaosocial"]}><img src="assets/Icon/twitter.svg" id={styles["icon"]} /></a></Link></li>
                        <li><Link href="#" ><a class={styles["botaosocial"]}><img src="assets/Icon/googleplus.svg" id={styles["icon"]} /></a></Link></li>
                        <li><Link href="#" ><a class={styles["botaosocial"]}><img src="assets/Icon/pinterest.svg" id={styles["icon"]} /></a></Link></li>
                        <li><Link href="#" ><a class={styles["botaosocial"]}><img src="assets/Icon/linkedin.svg" id={styles["icon"]} /></a></Link></li>
                        <li><Link href="#" ><a class={styles["botaosocial"]}><img src="assets/Icon/youtube.svg" id={styles["icon"]} /></a></Link></li>
                        <li><Link href="#" ><a class={styles["botaosocial"]}><img src="assets/Icon/insta.svg" id={styles["icon"]} /></a></Link></li>
                    </ul>
                </div>
